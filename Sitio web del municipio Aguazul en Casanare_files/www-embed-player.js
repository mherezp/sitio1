...
function Dg(a,b,c){if(0==a.b){a===c&&(b=3,c=new TypeError("Promise cannot resolve to itself"));a.b=1;var d;a:{var e=c,f=a.T,h=a.G;if(e instanceof Cg)Og(e,Gg(f||t,h||null,a)),d=!0;else{var k;if(e)try{k=!!e.$goog_Thenable}catch(n){k=!1}else k=!1;if(k)e.then(f,h,a),d=!0;else{if(ha(e))try{var l=e.then;if(ga(l)){Qg(e,l,f,h,a);d=!0;break a}}catch(n){h.call(a,n);d=!0;break a}d=!1}}}d||(a.l=c,a.b=b,a.g=null,Pg(a),3!=b||c instanceof Kg||Sg(a,c))}}
...
function vk(a,b){var c=b||{};"function"==typeof b&&(c={},c.callback=b);sk(a,c);var d=a?a.split(":"):[],e=c.h||nk(),f=T(U,"ah",Pj());if(f["::"]&&d.length){for(var h=[],k=null;k=d.shift();){var l=k.split("."),l=f[k]||f[l[1]&&"ns:"+l[0]||""]||e,n=h.length&&h[h.length-1]||null,G=n;n&&n.hint==l||(G={hint:l,features:[]},h.push(G));G.features.push(k)}var ca=h.length;if(1<ca){var ic=c.callback;ic&&(c.callback=function(){0==--ca&&ic()})}for(;d=h.shift();)wk(d.features,c,d.hint)}else wk(d||[],c,e)}
function wk(a,b,c){function d(a,b){if(ca)return 0;Ij.clearTimeout(G);ic.push.apply(ic,Ka);var d=((Qj||{}).config||{}).update;d?d(f):f&&T(U,"cu",[]).push(f);if(b){Wj("me0",a,$d);try{tk(b,c,n)}finally{Wj("me1",a,$d)}}return 1}
a=Oj(a)||[];var e=b.callback,f=b.config,h=b.timeout,k=b.ontimeout,l=b.onerror,n=void 0;"function"==typeof l&&(n=l);var G=null,ca=!1;if(h&&!k||!h&&k)throw"Timeout requires both the timeout parameter and ontimeout parameter to be set";var l=T(Tj(c),"r",[]).sort(),ic=T(Tj(c),"L",[]).sort(),$d=[].concat(l);0<h&&(G=Ij.setTimeout(function(){ca=!0;k()},h));
var Ka=pk(a,ic);if(Ka.length){var Ka=pk(a,l),ob=T(U,"CP",[]),pb=ob.length;ob[pb]=function(a){function b(){var a=ob[pb+1];a&&a()}
function c(b){ob[pb]=null;d(Ka,a)&&Sj(function(){e&&e();b()})}
if(!a)return 0;Wj("ml1",Ka,$d);0<pb&&ob[pb-1]?ob[pb]=function(){c(b)}:c(b)};
if(Ka.length){var Rg="loaded_"+U.I++;Qj[Rg]=function(a){ob[pb](a);Qj[Rg]=null};
a=fk(c,Ka,"gapi."+Rg,l);l.push.apply(l,Ka);Wj("ml0",Ka,$d);b.sync||Ij.___gapisync?qk(a):rk(a)}else ob[pb](Lj)}else d(Ka)&&e&&e()}
...
vp=null}
function Kp(){if(Nm()){var a=[];if(of("yt-remote-cast-available")||r("yt.mdx.remote.cloudview.castButtonShown_")||Lp())a.push({key:"cast-selector-receiver",name:Mp()}),q("yt.mdx.remote.cloudview.castButtonShown_",!0,void 0);return a}return r("yt.mdx.remote.cloudview.initializing_")?[]:Np()}
function Np(){var a;a=yp().Y.$_gos();var b=Op();b&&Lp()&&(xl(a,b)||a.push(b));return wl(a)}
function Pp(){if(Nm()){var a=Om();return a?{key:"cast-selector-receiver",name:a}:null}return Qp()}
function Qp(){var a=Np(),b=Op();b||(b=Ep());return Oa(a,function(a){return b&&ll(b,a.key)?!0:!1})}
function Mp(){if(Nm())return Om();var a=Op();return a?a.name:null}
function Op(){var a=zp();if(!a)return null;var b=yp().ea();return yl(b,a)}
function Dp(a){Ap("remote.onCastSessionChange_: "+pl(a));if(a){var b=Op();b&&b.id==a.id?Qm(b.id,"YouTube TV"):(b&&Rp(),Sp(a,1))}else Rp()}
function Rp(){Rm()?Jm().stopSession():Gm("stopSession called before API ready.");var a=Lp();a?a.disconnect(1):(uc("yt-remote-before-disconnect",1),uc("yt-remote-connection-change",!1));Tp(null)}
...
function Lp(){return r("yt.mdx.remote.connection_")}
function Tp(a){var b=Lp();Cp();a?Lp():Up("");q("yt.mdx.remote.connection_",a,void 0);wp&&(A(wp,function(b){b(a)}),wp.length=0);
...
function Sp(a,b){zp();Up(a.id);var c=new Z(vp,a,Fp());c.connect(b,r("yt.mdx.remote.connectData_"));c.subscribe("beforeDisconnect",function(a){uc("yt-remote-before-disconnect",a)});
c.subscribe("beforeDispose",function(){Lp()&&(Lp(),Tp(null))});
Tp(c)}
function Hp(){var a=Ep();a?(Ap("Resume connection to: "+pl(a)),Sp(a,0)):(Tl(),Pm(),Ap("Skipping connecting because no session screen found."))}
...
var Bp=[];var Vp=null,Wp=[];function Xp(){Yp();if(Pp()){var a=Vp;"html5"!=a.getPlayerType()&&a.loadNewVideoConfig(a.getCurrentVideoConfig(),"html5")}}
function Yp(){var a=Vp;a&&a.updateRemoteReceivers&&a.updateRemoteReceivers(Kp(),Pp())}
;var Zp=null,$p=[];function aq(a){return{externalChannelId:a.externalChannelId,Dd:!!a.isChannelPaid,source:a.source,subscriptionId:a.subscriptionId}}
function bq(a){cq(aq(a))}
function cq(a){gj()?(R(Ui,new Oi(a.externalChannelId,a.Dd?{itemType:"U",itemId:a.externalChannelId}:null)),(a="/gen_204?"+Ld({event:"subscribe",source:a.source}))&&Eh(a)):dq(a)}
function dq(a){fj(function(b){b.subscription_ajax&&cq(a)},null)}
function eq(a){a=aq(a);R(Zi,new Qi(a.externalChannelId,a.subscriptionId,null));(a="/gen_204?"+Ld({event:"unsubscribe",source:a.source}))&&Eh(a)}
function fq(a){Zp&&Zp.channelSubscribed(a.b,a.subscriptionId)}
function gq(a){Zp&&Zp.channelUnsubscribed(a.b)}
;function hq(a){D.call(this);this.f=a;this.f.subscribe("command",this.Hc,this);this.g={};this.i=!1}
z(hq,D);g=hq.prototype;g.start=function(){this.i||this.D()||(this.i=!0,iq(this.f,"RECEIVING"))};
g.Uc=u;g.addEventListener=u;g.removeEventListener=u;g.Hc=function(a,b){if(this.i&&!this.D()){var c=b||{};switch(a){case "addEventListener":if(w(c.event)&&(c=c.event,!(c in this.g))){var d=x(this.qe,this,c);this.g[c]=d;this.addEventListener(c,d)}break;case "removeEventListener":w(c.event)&&jq(this,c.event);break;default:this.Uc(a,b)}}};
g.qe=function(a,b){this.i&&!this.D()&&iq(this.f,a,this.Jb(a,b))};
g.Jb=function(a,b){if(null!=b)return{value:b}};
function jq(a,b){b in a.g&&(a.removeEventListener(b,a.g[b]),delete a.g[b])}
g.A=function(){this.f.unsubscribe("command",this.Hc,this);this.f=null;for(var a in this.g)jq(this,a);hq.C.A.call(this)};function kq(a,b){hq.call(this,b);this.b=a;this.start()}
...
g.Uc=function(a,b){if(this.b.isReady()&&this.b[a]){var c=lq(a,b||{}),c=this.b[a].apply(this.b,c);(c=mq(a,c))&&this.i&&!this.D()&&iq(this.f,a,c)}};
function lq(a,b){switch(a){case "loadVideoById":return b=Ik(b),Kk(b),[b];case "cueVideoById":return b=Ik(b),Kk(b),[b];case "loadVideoByPlayerVars":return Kk(b),[b];case "cueVideoByPlayerVars":return Kk(b),[b];case "loadPlaylist":return b=Jk(b),Kk(b),[b];case "cuePlaylist":return b=Jk(b),Kk(b),[b];case "seekTo":return[b.seconds,b.allowSeekAhead];case "playVideoAt":return[b.index];case "setVolume":return[b.volume];case "setPlaybackQuality":return[b.suggestedQuality];case "setPlaybackRate":return[b.suggestedRate];
...
g.Jb=function(a,b){switch(a){case "onReady":return;case "onStateChange":return{playerState:b};case "onPlaybackQualityChange":return{playbackQuality:b};case "onPlaybackRateChange":return{playbackRate:b};case "onError":return{errorCode:b}}return kq.C.Jb.call(this,a,b)};
g.A=function(){kq.C.A.call(this);delete this.b};function nq(a,b,c,d){D.call(this);this.b=b||null;this.B="*";this.i=c||null;this.f=null;this.channel=d||null;this.H=!!a;this.G=x(this.K,this);window.addEventListener("message",this.G)}
z(nq,D);nq.prototype.K=function(a){if(!("*"!=this.i&&a.origin!=this.i||this.b&&a.source!=this.b)&&w(a.data)){var b;try{b=ud(a.data)}catch(c){return}null!=b&&(this.H&&(this.f&&this.f!=b.id||this.channel&&this.channel!=b.channel)?window.console&&window.console.warn("Session ID or channel missmatch"):b&&this.l(a,b))}};
nq.prototype.l=u;nq.prototype.sendMessage=function(a){if(this.b){this.f&&(a.id=this.f);this.channel&&(a.channel=this.channel);try{var b=L(a);this.b.postMessage(b,this.B)}catch(c){hc(c,"WARNING")}}};
nq.prototype.A=function(){window.removeEventListener("message",this.G);nq.C.A.call(this)};function oq(a,b,c){nq.call(this,a,b,c||H("POST_MESSAGE_ORIGIN",void 0)||window.document.location.protocol+"//"+window.document.location.hostname,"widget");this.o=this.g=this.j=null}
z(oq,nq);oq.prototype.l=function(a,b){switch(b.event){case "listening":"null"!=a.origin?this.i=this.B=a.origin:hc(Error("MessageEvent origin is null"),"WARNING");this.b=a.source;this.f=b.id;this.g&&(this.g(),this.g=null);break;case "command":this.j&&(this.o&&!Qa(this.o,b.func)||this.j(b.func,b.args))}};function pq(){var a=this.f=new oq(!!H("WIDGET_ID_ENFORCE")),b=x(this.me,this);a.j=b;a.o=null;this.f.channel="widget";if(a=H("WIDGET_ID"))this.f.P=a;this.i=[];this.o=!1;this.j={}}
g=pq.prototype;g.me=function(a,b){if("addEventListener"==a&&b){var c=b[0];this.j[c]||"onReady"==c||(this.addEventListener(c,qq(this,c)),this.j[c]=!0)}else this.Vc(a,b)};
g.Vc=function(){};
...
g.dispose=function(){this.f=null};function sq(a){pq.call(this);this.b=a;this.g=[];this.addEventListener("onReady",x(this.Ud,this));this.addEventListener("onVideoProgress",x(this.ue,this));this.addEventListener("onVolumeChange",x(this.ve,this));this.addEventListener("onApiChange",x(this.pe,this));this.addEventListener("onPlaybackQualityChange",x(this.re,this));this.addEventListener("onPlaybackRateChange",x(this.se,this));this.addEventListener("onStateChange",x(this.te,this))}
z(sq,pq);g=sq.prototype;g.Vc=function(a,b){if(this.b[a]){b=b||[];if(0<b.length&&Gk(a)){var c;c=b;if(ha(c[0])&&!v(c[0]))c=c[0];else{var d={};switch(a){case "loadVideoById":case "cueVideoById":d=Ik.apply(window,c);break;case "loadVideoByUrl":case "cueVideoByUrl":d=Hk.apply(window,c);break;case "loadPlaylist":case "cuePlaylist":d=Jk.apply(window,c)}c=d}Kk(c);b.length=1;b[0]=c}this.b[a].apply(this.b,b);Gk(a)&&rq(this,this.Kb())}};
...
g.re=function(a){rq(this,{playbackQuality:a})};
g.se=function(a){rq(this,{playbackRate:a})};
...
g.ve=function(){rq(this,{muted:this.b.isMuted(),volume:this.b.getVolume()})};
g.ue=function(a){a={currentTime:a,videoBytesLoaded:this.b.getVideoBytesLoaded(),videoLoadedFraction:this.b.getVideoLoadedFraction(),currentTimeLastUpdated_:y()/1E3,playbackRate:this.b.getPlaybackRate()};this.b.getProgressState&&(a.progressState=this.b.getProgressState());rq(this,a)};
...
tq.prototype.A=function(){this.f=this.b=null;tq.C.A.call(this)};function uq(a,b,c){D.call(this);this.b=a;this.g=c;this.i=M(window,"message",x(this.j,this));this.f=new tq(this,a,b);$b(this,na(E,this.f))}
z(uq,D);uq.prototype.j=function(a){var b;if(b=!this.D()&&a.origin==this.g)a:{b=this.b;do{var c;b:{c=a.source;do{if(c==b){c=!0;break b}if(c==c.parent)break;c=c.parent}while(null!=c);c=!1}if(c){b=!0;break a}b=b.opener}while(null!=b);b=!1}if(b&&(a=a.data,w(a))){try{a=ud(a)}catch(d){return}a.command&&(b=this.f,b.D()||b.w("command",a.command,a.data))}};
uq.prototype.A=function(){Te(this.i);this.b=null;uq.C.A.call(this)};var vq=!1;function wq(a){if(a=a.match(/[\d]+/g))a.length=3}
...
new ActiveXObject("ShockwaveFlash.ShockwaveFlash.6");vq=!0;return}catch(c){}try{b=new ActiveXObject("ShockwaveFlash.ShockwaveFlash"),vq=!0,wq(b.GetVariable("$version"))}catch(c){}})();function xq(a){return(a=a.exec(qb))?a[1]:""}
(function(){if(sf)return xq(/Firefox\/([0-9.]+)/);if(K||fd||ed)return od;if(wf)return xq(/Chrome\/([0-9.]+)/);if(xf&&!(ad()||B("iPad")||B("iPod")))return xq(/Version\/([0-9.]+)/);if(tf||uf){var a=/Version\/(\S+).*Mobile\/(\S+)/.exec(qb);if(a)return a[1]+"."+a[2]}else if(vf)return(a=xq(/Android\s+([0-9.]+)/))?a:xq(/Version\/([0-9.]+)/);return""})();function yq(){var a=zq;return new Cg(function(b,c){a.R=function(a){Rd(a)?b(a):c(a)};
a.onError=c;a.ka=c;Wd("//googleads.g.doubleclick.net/pagead/id",a)})}
;function Aq(a,b){this.f=a;this.b=b}
Aq.prototype.then=function(a,b,c){try{if(p(this.f))return a?Hg(a.call(c,this.f)):Hg(this.f);if(p(this.b)){if(!b)return Ig(this.b);var d=b.call(c,this.b);return!p(d)&&this.b instanceof Kg?Ig(this.b):Hg(d)}throw Error("Invalid Result_ state");}catch(e){return Ig(e)}};
Bg(Aq);var zq={format:"RAW",method:"GET",timeout:5E3,withCredentials:!0},Bq=null;function Cq(a){a=a.responseText;if(0!=a.lastIndexOf(")]}'",0))return Dq(""),Bq=new Aq(""),"";a=JSON.parse(a.substr(4)).id;Dq(a);Bq=new Aq(a);Eq(18E5,2);return a}
function Fq(a){var b=Error("Unable to load /pagead/id");Dq("");Bq=new Aq(void 0,b);0<a&&Eq(12E4,a-1);throw b;}
function Eq(a,b){I(function(){var a=x(Fq,m,b),a=yq().then(Cq,a);Jg(a,null,t,void 0)},a)}
function Dq(a){q("yt.www.ads.biscotti.lastId_",a,void 0)}
;function Gq(){}
;function Hq(){var a;if(a=Rf.get("PREF",void 0)){a=unescape(a).split("&");for(var b=0;b<a.length;b++){var c=a[b].split("="),d=c[0];(c=c[1])&&(Iq[d]=c.toString())}}}
...
Hq.prototype.clear=function(){Iq={}};function Mq(a){for(var b=0;b<a.length;b++){var c=a[b];"send_follow_on_ping_action"==c.name&&c.data&&c.data.follow_on_url&&(c=c.data.follow_on_url)&&Eh(c)}}
;function Nq(a){P.call(this,1,arguments);this.Fb=a}
...
z(Rq,P);var Sq=new Q("ypc-core-load",Nq),Tq=new Q("ypc-guide-sync-success",Oq),Uq=new Q("ypc-purchase-success",Pq),Vq=new Q("ypc-subscription-cancel",Rq),Wq=new Q("ypc-subscription-cancel-success",Qq),Xq=new Q("ypc-init-subscription",Rq);var Yq=!1,Zq=[],$q=[];function ar(a){a.b?Yq?R(Yi,a):R(Sq,new Nq(function(){R(Xq,new Rq(a.b))})):br(a.f,a.i,a.g,a.source)}
function cr(a){a.b?Yq?R(cj,a):R(Sq,new Nq(function(){R(Vq,new Rq(a.b))})):dr(a.f,a.subscriptionId,a.i,a.g,a.source)}
function er(a){fr(Va(a.b))}
function gr(a){hr(Va(a.b))}
function ir(a){jr(a.g,a,null)}
function kr(a,b,c,d){jr(a,b,c,d)}
function lr(a){var b=a.itemId,c=a.b.subscriptionId;b&&c&&R(Xi,new Pi(b,c,a.b.channelInfo))}
function mr(a){var b=a.b;$a(a.f,function(a,d){R(Xi,new Pi(d,a,b[d]))})}
function nr(a){R(bj,new Mi(a.f.itemId));a.b&&a.b.length&&(or(a.b,bj),or(a.b,dj))}
function br(a,b,c,d){var e=new Mi(a);R(Vi,e);var f={};f.c=a;c&&(f.eurl=c);d&&(f.source=d);c={};(d=H("PLAYBACK_ID"))&&(c.plid=d);(d=H("EVENT_ID"))&&(c.ei=d);b&&pr(b,c);Wd("/subscription_ajax?action_create_subscription_to_channel=1",{method:"POST",Wb:f,O:c,R:function(b,c){var d=c.response;R(Xi,new Pi(a,d.id,d.channel_info));d.show_feed_privacy_dialog&&tc("SHOW-FEED-PRIVACY-SUBSCRIBE-DIALOG",a);d.actions&&Mq(d.actions)},
Tb:function(){R(Wi,e)}})}
function dr(a,b,c,d,e){var f=new Mi(a);R($i,f);var h={};d&&(h.eurl=d);e&&(h.source=e);d={};d.c=a;d.s=b;(a=H("PLAYBACK_ID"))&&(d.plid=a);(a=H("EVENT_ID"))&&(d.ei=a);c&&pr(c,d);Wd("/subscription_ajax?action_remove_subscriptions=1",{method:"POST",Wb:h,O:d,R:function(a,b){var c=b.response;R(bj,f);c.actions&&Mq(c.actions)},
Tb:function(){R(aj,f)}})}
...
R:function(){d&&d()}})}}
function fr(a){if(a.length){var b=Xa(a,0,40);R("subscription-batch-subscribe-loading");or(b,Vi);var c={};c.a=b.join(",");var d=function(){R("subscription-batch-subscribe-loaded");or(b,Wi)};
...
function hr(a){if(a.length){var b=Xa(a,0,40);R("subscription-batch-unsubscribe-loading");or(b,$i);var c={};c.c=b.join(",");var d=function(){R("subscription-batch-unsubscribe-loaded");or(b,aj)};
Wd("/subscription_ajax?action_remove_subscriptions=1",{method:"POST",O:c,R:function(){d();or(b,bj);a.length&&hr(a)},
onError:function(){d()}})}}
function or(a,b){A(a,function(a){R(b,new Mi(a))})}
function pr(a,b){var c=Od(a),d;for(d in c)b[d]=c[d]}
;var qr=null,rr=null,sr=null,tr=!1;function ur(a){var b=Mf();b&&Kf(Jf(),{click:{csn:b,visualElement:zf(new yf(a))}},void 0)}
function vr(a){var b=Mf();if(b){for(var c=[],d=0;d<a.length;d++)c.push(new yf(a[d]));If(b,c)}}
...
q("writeEmbed",function(){var a=H("PLAYER_CONFIG",void 0);if("1"!=a.privembed)try{var b;try{var c=r("yt.www.ads.biscotti.getId_"),d;if(c)d=c();else{if(!Bq){var e=x(Fq,m,2);Bq=yq().then(Cq,e)}d=Bq}b=d}catch(f){b=Ig(f)}Jg(b,null,Gq,void 0)}catch(f){hc(f)}"gvn-experiment"==a.args.ps&&(document.body.style.backgroundColor="transparent");d=document.referrer;b=H("POST_MESSAGE_ORIGIN");c=!1;Cd("legacy_cast2")&&w(d)&&w(b)&&-1<d.indexOf(b)&&Bh(b)&&Bh(d)&&(c=!0);window!=window.top&&d&&d!=document.URL&&(a.args.loaderUrl=
d);H("LIGHTWEIGHT_AUTOPLAY")&&(a.args.autoplay="1");a.args.autoplay&&Kk(a.args);qr=d=zi("player",a);d.addEventListener("onLogServerVeClicked",ur);d.addEventListener("onLogServerVesShown",vr);e=H("POST_MESSAGE_ID","player");H("ENABLE_JS_API")?sr=new sq(d):H("ENABLE_POST_API")&&w(e)&&w(b)&&(rr=new uq(window.parent,e,b),sr=new kq(d,rr.f));Cd("legacy_cast2")&&((tr=c&&!H("ENABLE_CAST_API"))?a.args.disableCast="1":(up(),Vp=d,Vp.addEventListener("onReady",Xp),Wp.push(qc("yt-remote-receiver-availability-change",
Yp))));H("BG_P")&&(H("BG_I")||H("BG_IU"))&&Gc();ge();Zp=d;Zp.addEventListener("SUBSCRIBE",bq);Zp.addEventListener("UNSUBSCRIBE",eq);$p.push(Mh(Xi,fq),Mh(bj,gq))},void 0);
q("yt.www.watch.ads.restrictioncookie.spr",function(a){(a+="mac_204?action_fcts=1")&&Eh(a);return!0},void 0);
var wr=gc(function(){Wh("ol");Yq=!0;$q.push(Mh(Ui,ar),Mh(Zi,cr));Yq||($q.push(Mh(Yi,ar),Mh(cj,cr),Mh(Ri,er),Mh(Si,gr),Mh(Ti,ir)),Zq.push(qc("subscription-prefs",kr)),$q.push(Mh(Uq,lr),Mh(Wq,nr),Mh(Tq,mr)));Hq.getInstance();var a=1<window.devicePixelRatio;if(!!((Lq("f"+(Math.floor(119/31)+1))||0)&67108864)!=a){var b="f"+(Math.floor(119/31)+1),c=Lq(b)||0,c=a?c|67108864:c&-67108865;0==c?delete Iq[b]:(a=c.toString(16),Iq[b]=a.toString());var b=[],d;for(d in Iq)b.push(d+"="+escape(Iq[d]));Sf("PREF",b.join("&"),
63072E3)}}),xr=gc(function(){var a=qr;
a&&a.sendAbandonmentPing&&a.sendAbandonmentPing();H("PL_ATT")&&(Fc=null);for(var a=0,b=ee.length;a<b;a++){var c=ee[a];if(!isNaN(c)){var d=r("yt.scheduler.instance.cancelJob");d?d(c):J(c)}}ee.length=0;a=Bc("//static.doubleclick.net/instream/ad_status.js");if(b=document.getElementById(a))wc(a),b.parentNode.removeChild(b);fe=!1;ec("DCLKSTAT",0);sc(Zq);Zq.length=0;Nh($q);$q.length=0;Yq=!1;Zp&&(Zp.removeEventListener("SUBSCRIBE",cq),Zp.removeEventListener("UNSUBSCRIBE",eq));Zp=null;Nh($p);$p.length=0;
Cd("legacy_cast2")&&!tr&&(sc(Wp),Wp.length=0,Vp&&(Vp.removeEventListener("onReady",Xp),Vp=null),Ip());ac(sr,rr);if(a=qr)a.removeEventListener("onLogServerVeClicked",ur),a.removeEventListener("onLogServerVesShown",vr),a.destroy()});
window.addEventListener?(window.addEventListener("load",wr),window.addEventListener("unload",xr)):window.attachEvent&&(window.attachEvent("onload",wr),window.attachEvent("onunload",xr));var yr=Cj.getInstance(),zr=S(yr);zr in Hj||(yr.register(),yr.wb.push(qc("yt-uix-init-"+zr,yr.init,yr)),yr.wb.push(qc("yt-uix-dispose-"+zr,yr.dispose,yr)),Hj[zr]=yr);})();
